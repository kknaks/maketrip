...
CREATE TABLE `locationtype` (
  `locationtype_no` int NOT NULL COMMENT '여행지구분',
  PRIMARY KEY (`locationtype_no`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='여행지구분';
...
INSERT INTO `locationtype` VALUES (1),(2);
