...
CREATE TABLE `firstclass` (
  `firstclass_code` varchar(50) NOT NULL COMMENT '대분류코드',
  `firstclass_name` varchar(50) NOT NULL COMMENT '대분류명',
  PRIMARY KEY (`firstclass_code`),
  UNIQUE KEY `UIX_firstclass` (`firstclass_code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='여행지유형대분류';
...
INSERT INTO `firstclass` VALUES ('A01','자연'),('A02','인문(문화/예술/역사)'),('A03','레포츠'),('A04','쇼핑'),('A05','음식'),('B02','숙박'),('C01','추천코스');
