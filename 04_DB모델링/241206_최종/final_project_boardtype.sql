...
CREATE TABLE `boardtype` (
  `boardtype_no` int NOT NULL AUTO_INCREMENT COMMENT '게시글분류번호',
  `boardtype_name` varchar(50) NOT NULL COMMENT '게시글분류명',
  PRIMARY KEY (`boardtype_no`),
  UNIQUE KEY `UIX_boardtype` (`boardtype_name`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='게시글분류';
...
INSERT INTO `boardtype` VALUES (2,'여행동행'),(1,'여행질문'),(3,'여행후기');
